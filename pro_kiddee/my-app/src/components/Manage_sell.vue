              ...
              <v-dialog v-model="dialog" max-width="500px">
                ...
                <v-card>
                    ...
                    <v-container grid-list-md>
                      <v-layout wrap>
                        ...
                        <v-flex xs12 sm6 md12>
                          <v-text-field v-model="editedItem.sell_name" label="หัวข้อในการลงขาย"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md12>
                          <v-text-field v-model="editedItem.sell_address" label="ที่อยู่ที่ต้องการมารับจากการขาย"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md12>
                          <v-text-field type="number" v-model="editedItem.sell_price" label="ราคา/ชิ้น"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md12>
                          <v-text-field v-model="editedItem.description" label="รายละเอียด"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md12>
                          <v-text-field type="number" v-model="editedItem.sell_number" label="จำนวนที่ลงขาย"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md12>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn color="blue darken-1" flat @click="update_data()">Update</v-btn>
                  </v-card-actions>
                </v-card>
              </v-dialog>
            </v-toolbar>
